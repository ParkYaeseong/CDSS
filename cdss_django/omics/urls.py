...
from .views import (
    ...
    ClassifyCancerTypeView,
    PatientOmicsRequestListView,
    OmicsResultDetailView
)
...
urlpatterns = [
    ...
    path('results/<uuid:request_id>/', OmicsResultDetailView.as_view(), name='omics-result-detail'),
]